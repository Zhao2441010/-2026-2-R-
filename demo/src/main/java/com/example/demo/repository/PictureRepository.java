...
public interface PictureRepository extends JpaRepository<Picture,Long> {
    ...
    List<Picture> findByCatId(Long catId);

    @Query("select p from Picture p where p.display=false and p.catId=:catId")
    List<Picture> selectUnDisplayPictureByCatid(@Param("catId") Long cid);
